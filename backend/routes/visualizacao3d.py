        ...
        dados = [
            {
                "id": str(i),
                "descricao": "",
                "elemdespesatce": f"{df['elemdespesatce'].iloc[i]}",
                "var_x": 0.0,
                "var_y": 0.0,
                "var_z": 0.0,
                "x": float(embed[0]),
        ...
        dados = [
            {
                ...
                "dt_empenho": f"{df.iloc[i]['dtempenho']}",
                "vlr_empenho": f"{df.iloc[i]['vlr_empenho']}",
                "var_x": float(var_X)*10,
                "var_y": float(var_Y)*10,
                "var_z": float(var_Z)*10,
                "x": float(embed[0])*2,
                "y": float(embed[1])*2,
                "z": float(embed[2])*2,
                "color": "#e6194b"
